  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="ts.php"><i class="fa fa-link"></i> <span>Ticket Status</span></a></li>
        <li><a href="rh.php"><i class="fa fa-link"></i> <span>Request for Hiring</span></a></li>
        ...
        <li class="active"><a href="bus_details.php"><i class="fa fa-link"></i> <span>Bus Details</span></a></li>
...
<body>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h1>Bus Update<a href="bus_details.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
          <form action="busUpdate.php" method="post" class="post">

              <div class="form-group">
                <label for="id">Id</label>
                <input type="number" id="name" value="<?php echo $data['b_id'] ?>" name="b_id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="no">Driver Id</label>
                <input type="text" id="no" value="<?php echo $data['d_id'] ?>" name="d_id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="no">Supervisor Id</label>
                <input type="number" id="no" value="<?php echo $data['su_id'] ?>" name="su_id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="no">Bus Seat Number</label>
                <input type="text" id="no" value="<?php echo $data['b_seat_number'] ?>" name="b_seat_number" class="form-control" placeholder="Enter Your Phone" required>
              </div>     
              ...
              <div class="form-group">
                <label for="no">For</label>
                <input type="text" id="no" value="<?php echo $data['process'] ?>" name="p_type" class="form-control" placeholder="Enter Your Name" required>
              </div> 
...
<?php
    if(isset($_POST['submit'])){
      ...
      $q="UPDATE `bus` SET `d_id`='$did',`su_id`='$suid',`b_seat_number`='$bseat' , `b_type`='$btype' ,`process`='$ptype' WHERE `b_id`='$bid'";
      ...
      if($urun==true){
        ...
        <script>
          ...
          window.open('bus_details.php','_self');
        </script>
        <?php
      }
      else{
