...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="driver_details.php"><i class="fa fa-link"></i> <span>Driver Details</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    $id=$_GET['id'];
    $q="SELECT * FROM `driver` WHERE `d_id`='$id'";
...
?>
    ...
    <div class="row">
      <div class="col-sm-12">
        <h1>Driver Update<a href="driver_details.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
          <form action="driverUpdate.php" method="post" class="post">

              <div class="form-group">
                <label for="id">Id</label>
                <input type="text" id="name" value="<?php echo $data['d_id'] ?>" name="id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="name">Name</label>
                <input type="text" id="name" value="<?php echo $data['d_name'] ?>" name="name" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="phone">Phone No.</label>
                <input type="number" id="phone" value="<?php echo $data['d_phone_no'] ?>" name="phone" class="form-control" placeholder="Enter Your Phone" required>
              </div>             
...
<?php
    if(isset($_POST['submit'])){
      ...
      $q="UPDATE `driver` SET `d_name`='$dname',`d_phone_no`='$dphone' WHERE `d_id`='$did'";
      ...
      if($urun==true){
        ...
        <script>
          alert('Update fail.');
          window.open('driverUpdate.php','_self');
        </script>
        <?php
      }
