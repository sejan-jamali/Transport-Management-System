...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="supervisor_details.php"><i class="fa fa-link"></i> <span>Supervisor Details</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-sm-12">
      	<h1>Supervisor Add<a href="supervisor_details.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
          <form action="#" method="POST" class="post">
              ...
              <div class="form-group">
                <label for="phone">Supervisor Pone No.</label>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$q="INSERT INTO `supervisor`(`su_name`, `su_phone_no`) VALUES ('$name','$phone')";
		...
		if($run==true){
			...
			<script>
				...
				window.open('supervisor_details.php','_self');
			</script>
			<?php
		}
		else{
			...
			<script>
				...
				window.open('supervisorAdd.php','_self');
			</script>
			<?php
		}
