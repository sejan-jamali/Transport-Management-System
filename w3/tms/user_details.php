        ...
        while($row=mysqli_fetch_array($run)){
                ?>
                   <tr>
                    ...
                    <td>
                      <a href="userUpdate.php?id=<?php echo $row['u_id'] ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>Update</a>
                      <a onclick="return confirm('Are Yur Sure?To delete!')" href="userDelete.php?id=<?php echo $row['u_id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a>
                    </td>
                   </tr>
                <?php
                  }
