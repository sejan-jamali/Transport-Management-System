...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-sm-12">
          <h1>Schedule Details<a href="Schedule.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Add a new Schedule</a></h1>
             ...
             <?php
                ...
                ?>
                   <tr>
                    ...
                    <td>
                      <a onclick="return confirm('Are Yur Sure?To delete!')" href="ScheduleDelete.php?id=<?php echo $row['s_id'] ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a>
                    </td>
                   </tr>
                <?php
                  }
