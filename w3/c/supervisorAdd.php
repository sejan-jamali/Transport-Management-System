...
<body>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
      	<h1>Supervisor Add<a href="supervisorDetails.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
