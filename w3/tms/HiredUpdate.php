...
<?php
  ...
  $id=$_GET['id'];
  $q="SELECT * FROM `hired_bus` WHERE `h_id`='$id'";
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="rh.php"><i class="fa fa-link"></i> <span>Request for Hiring</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-sm-12">
        <h1>Hired BusUpdate<a href="HiredDetails.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
          <form action="#" method="post" class="post">

              <div class="form-group">
                <label for="id">Id</label>
                <input type="text" id="name" value="<?php echo $data['h_id'] ?>" name="id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="id">Amount</label>
                <input type="text" id="name" value="<?php echo $data['amount'] ?>" name="id" class="form-control" placeholder="Enter Your Name" required>
              </div>

              <div class="form-group">
                <label for="id">Payment</label>
                <input type="text" id="name" value="<?php echo $data['h_payment'] ?>" name="id" class="form-control" placeholder="Enter Your Name" required>
              </div>
...
<?php
    if(isset($_POST['submit'])){
      ...
      $q="UPDATE `hired_bus` SET `h_payment_status`='$pstatus' WHERE `h_id`='$id'";
      ...
      if($urun==true){
        ...
        <script>
          alert('Update fail.');
          window.open('HiredUpdate.php','_self');
        </script>
        <?php
      }
