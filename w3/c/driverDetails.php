...
<body>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
          <h1>Drivers Details<a href="driverAdd.php" class="btn btn-info pull-right"><span class="gglyphicon glyphicon-plus-sign" aria-hidden="true"></span>Driver Add</a></h1>
