...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-sm-12">
        <h1>Bus Add<a href="bus_details.php" class="btn btn-info pull-right"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>Back</a></h1>
          <br>
          <form action="#" method="POST" class="post">
              ...
              <div class="form-group">
                ...
                <input type="number" id="no" name="d_id" class="form-control" placeholder="Enter Driver Id" required>
              </div>

              <div class="form-group">
                <label for="no">Supervisor Id</label>
                <input type="number" id="no" name="su_id" class="form-control" placeholder="Enter Supervisor Id." required>
              </div>
...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $q="INSERT INTO `bus`(`d_id`, `su_id`, `b_no`, `b_seat_number`, `b_type`, `process`) VALUES ('$d_id','$su_id','$b_no','$seat_no','$b_type','$p_type')";
